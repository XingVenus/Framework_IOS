...
-(id)init
{
    self = [super init];
    if (self) {
        NSString *useravatar = [CacheBox getCache:USER_AVATAR];
        ...
        NSString *phone = [CacheBox getCache:TEL_CACHE];
        ...
        NSDictionary *userinfo = @{@"avatar":useravatar?useravatar:@"",@"username":username?username:@"",@"email":email?email:@"",@"create_time":createtime?createtime:@"",@"phone":phone?phone:@"",@"uid":uid?uid:@"",@"star":star?star:@"",@"role_id":roleid?roleid:@"",@"status":status?status:@""};
        if (userinfo) {
...
-(void)updateUserInfo:(NSDictionary *)userinfo
{
    ...
    [CacheBox saveCache:USER_AVATAR value:model.avatar];
    ...
    [CacheBox saveCache:TEL_CACHE value:model.phone];
