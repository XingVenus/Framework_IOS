...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.showBorderLine) {
        ...
        topLayer.backgroundColor = self.borderLineColor ? self.borderLineColor.CGColor : [UIColor lightGrayColor].CGColor;
        CALayer *bottomLayer = [CALayer layer];
        bottomLayer.frame = CGRectMake(0, self.bounds.size.height, SCREEN_WIDTH, 0.5);
        bottomLayer.backgroundColor = self.borderLineColor ? self.borderLineColor.CGColor : [UIColor lightGrayColor].CGColor;
