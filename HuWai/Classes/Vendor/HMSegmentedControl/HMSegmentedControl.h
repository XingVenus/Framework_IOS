...
/*
 Default is NO. Set to YES to add top and bottom border line  (add by jx at 2015.2.26)
 */
@property (nonatomic, getter = isShowBorderLine) BOOL showBorderLine;
/*
 Color for the self's border
